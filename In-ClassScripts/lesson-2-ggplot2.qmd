...
```{r}
#| label: ggplot2_points_aes_color
#| eval: true
...
```{r}
#| label: ggplot2_points_color_aes
#| eval: true
ggplot(data = penguins) +
  geom_point(aes(x = body_mass_g, 
                 y = bill_length_mm,
...
```{r}
#| label: ggplot2_points_rcolorbrewer
#| eval: true
ggplot(data = penguins) +
  geom_point(aes(x = body_mass_g, 
                 y = bill_length_mm,
...
```{r}
#| label: ggplot2_manual_theme_swap
#| eval: true
ggplot(data = penguins) +
  geom_point(aes(x = body_mass_g, 
                 y = bill_length_mm,
...
Now that we have a publication ready visualization, let's save it using the 
`ggsave` function. `ggsave` makes saving our visualizations easier than using 
`dev.off()`.

```{r}
#| label: ggplot2_ggsave
#| eval: true
ggplot(data = penguins) +
  geom_point(aes(x = body_mass_g, 
                 y = bill_length_mm,
  ...
  theme(axis.title.x = element_text(size = 14),
        ...
        legend.text = element_text(size = 12),
        legend.position = "bottom") 
ggsave("ggplot_penguins_mass_comparison.pdf",
       height = 5,
       width = 8)
```
